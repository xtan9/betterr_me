...
export function CalendarHeader({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border px-card-header-padding-x py-card-header-padding-y">
      ...
      >
        <ToggleGroupItem value="day" className="rounded-l-control text-caption px-3">
          {t("views.day")}
        </ToggleGroupItem>
        <ToggleGroupItem value="week" className="text-caption px-3">
          {t("views.week")}
        </ToggleGroupItem>
        <ToggleGroupItem value="month" className="rounded-r-control text-caption px-3">
          {t("views.month")}
        </ToggleGroupItem>
      </ToggleGroup>
    </div>
