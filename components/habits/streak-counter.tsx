...
export const StreakCounter = memo(function StreakCounter({
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <div className="rounded-card border p-card-padding">
        <p className="text-caption text-muted-foreground uppercase tracking-wide">{t("current")}</p>
        ...
        {isPersonalBest && (
          <p className="text-caption font-medium text-primary mt-1">{t("personalBest")}</p>
        )}
      </div>
      <div className="rounded-card border p-card-padding">
        <p className="text-caption text-muted-foreground uppercase tracking-wide">{t("best")}</p>
        <div className="flex items-center gap-1.5 mt-1">
