...
describe("describeRecurrence", () => {
  // Mock translation function that returns the key with interpolated params
  const t = (key: string, params?: Record<string, unknown>): string => {
    const messages: Record<string, string> = {
      "recurrence.describe.everyDay": "Every day",
      "recurrence.describe.everyNDays": `Every ${params?.interval} days`,
      "recurrence.describe.everyWeek": "Every week",
      "recurrence.describe.everyNWeeks": `Every ${params?.interval} weeks`,
      "recurrence.describe.weeklyOnDays": `${params?.prefix} on ${params?.days}`,
      "recurrence.describe.everyMonth": "Every month",
      "recurrence.describe.everyNMonths": `Every ${params?.interval} months`,
      "recurrence.describe.monthlyOnOrdinal": `${params?.prefix} on the ${params?.ordinal}`,
      "recurrence.describe.monthlyOnWeekday": `${params?.prefix} on the ${params?.position} ${params?.day}`,
      "recurrence.describe.everyYear": "Every year",
      "recurrence.describe.everyNYears": `Every ${params?.interval} years`,
      "recurrence.describe.yearlyOnDate": `${params?.prefix} on ${params?.month} ${params?.day}`,
      "recurrence.describe.dayName.0": "Sun",
      "recurrence.describe.dayName.1": "Mon",
      "recurrence.describe.dayName.2": "Tue",
      "recurrence.describe.dayName.3": "Wed",
      "recurrence.describe.dayName.4": "Thu",
      "recurrence.describe.dayName.5": "Fri",
      "recurrence.describe.dayName.6": "Sat",
      "recurrence.describe.monthName.1": "January",
      "recurrence.describe.monthName.2": "February",
      "recurrence.describe.monthName.3": "March",
      "recurrence.describe.monthName.12": "December",
      "recurrence.describe.ordinal_one": `${params?.n}st`,
      "recurrence.describe.ordinal_two": `${params?.n}nd`,
      "recurrence.describe.ordinal_few": `${params?.n}rd`,
      "recurrence.describe.ordinal_other": `${params?.n}th`,
      "recurrence.describe.position.first": "first",
      "recurrence.describe.position.second": "second",
      "recurrence.describe.position.last": "last",
    };
