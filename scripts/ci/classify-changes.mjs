...
export const OWNERSHIP_REGISTRY = [
  ...
  rule("settings", [/^components\/settings\//, /^app\/(?:dashboard\/settings|api\/profile)\//, /^lib\/(?:preferences|profile-preference-cache|db\/profiles|hooks\/use-timezone|validations\/(?:preferences|profile))/,], fullE2E()),
