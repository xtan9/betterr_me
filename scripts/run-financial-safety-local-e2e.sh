...
package_manager="${PNPM_COMMAND:-pnpm}"
...
FINANCIAL_SAFETY_LOCAL_E2E=1 CI=1 ${package_manager} exec playwright test e2e/financial-safety.spec.ts --project=financial-safety-local --workers=1 --retries=0
