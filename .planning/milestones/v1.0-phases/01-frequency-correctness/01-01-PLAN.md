...
it('handles weekly frequency (any day counts)', () => {
  ...
  expect(result.missed_scheduled_periods).toBe(6); // 6 days missed (Feb 3-8), not 0
...
it('counts missed days for weekly frequency (day-level granularity)', () => {
  ...
  expect(result.missed_scheduled_periods).toBe(13); // 13 consecutive days missed (Jan 27 - Feb 8)
