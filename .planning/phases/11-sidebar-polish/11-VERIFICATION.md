...
|------------------------------------------------------------|---------------------------------------------------|------------|-----------------------------------------------------------------------------------------------------------------|
| `app/globals.css`                                          | Sidebar hover/active CSS tokens and width 224px   | VERIFIED   | Contains `--sidebar-hover-bg`, `--sidebar-hover-ring`, `--sidebar-hover-text`, `--sidebar-active-bg`, `--sidebar-active-ring`, `--sidebar-icon-bg`, `--sidebar-item-radius` in both `:root` and `.dark`. `--sidebar-width: 224px` set. 2 occurrences of `--sidebar-hover-bg` confirmed. |
